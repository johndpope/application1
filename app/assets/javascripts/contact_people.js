$(function () {
  function collectPhones() {
    ...
    $("#contact_person_phones_csv").val(phone_numbers);
  }

  function phone_mask(){
    $("div.phone-row .phone, .fax").each(function (){
  ...
  $( document ).ready(function() {
    if ($("#contact_person_phones_csv").val() == "") {
      $("#phones_add").trigger("click");
    }
    collectPhones();
    phone_mask();

    $('.new_contact_person, .edit_contact_person').submit(function (e) {
      collectPhones();
    });
  });
});
