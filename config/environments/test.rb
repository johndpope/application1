Broadcaster::Application.configure do
  ...
  config.active_support.deprecation = :stderr
	config.routes_default_url_options = {host: 'localhost:3000'}
end

#don't remove this config
Paperclip::Attachment.default_options[:path] = "#{Rails.root}/public/system/test/:base_class/:id_partition/:style/:basename.:extension"
Paperclip::Attachment.default_options[:url] = "/system/test/:base_class/:id_partition/:style/:basename.:extension"
